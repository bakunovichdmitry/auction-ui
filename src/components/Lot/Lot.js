...
import {IN_PROGRESS} from "../../constants/AuctionStatus";
import {ENGLISH} from "../../constants/AuctionType";
...
const Lot = () => {
  ...
  useEffect(() => {
      if (!loading) {
        ...
        // );
        const socket = new WebSocket(
          `ws://localhost:8000/ws/auctions/${auction.unique_id}/`
        );
    ...
    }, [auction.unique_id, loading, uuid]
  )
    ...
    <div className="lot-detail__wrapper">
      <div style={{width: "60%", display: "flex"}}>
        ...
        <div style={{marginLeft: "30px"}}>
          <div
            style={{color: "black", margin: "12px 0 2px 0", fontSize: "22px", fontWeight: "bold"}}
          ...
          <div>
            ...
            <div className="lot__property">
              {new Date(closing_date).toLocaleString('en-US', {
                weekday: 'short',
                day: 'numeric',
                year: 'numeric',
                month: 'long',
